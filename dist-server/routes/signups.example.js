...
router.post('/', async (req, res) => {
    try {
        const { firstName, lastName, email, phone, dogName, dogBreed, dogAge, dogExperience, classId, } = req.body;
        ...
        const [classCheck] = await pool.query('SELECT * FROM classes WHERE class_id = ?', [classId]);
